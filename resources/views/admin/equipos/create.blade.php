<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Registrar Equipo</h2>
    </x-slot>
    ...
    <div class="py-6 max-w-3xl mx-auto bg-white p-6 rounded shadow">
        <form action="{{ route('admin.equipos.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" class="border rounded px-3 py-2 w-full">
            ...
            <div class="mb-4">
                ...
                <textarea name="descripcion" class="border rounded px-3 py-2 w-full">{{ old('descripcion') }}</textarea>
