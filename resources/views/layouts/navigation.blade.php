<nav x-data="{ open: false }" class="bg-gradient-to-r from-blue-700 to-indigo-800 shadow-md">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden sm:flex space-x-6 ml-6">
                    ...
                    <a href="{{ route('dashboard') }}" class="text-white hover:text-blue-200 font-medium transition">
                        Dashboard
                    </a>
                    ...
                    <div x-data="notifDropdown()" class="relative">
                        ...
                        <div x-show="isOpen" @click.outside="isOpen = false"
                            ...
                            <div class="px-4 py-3 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                                ...
                                @if(Auth::user()->notificacionesNoLeidas() > 0)
                                    <span class="text-xs text-blue-600 font-medium">{{ Auth::user()->notificacionesNoLeidas() }}
                                        nuevas</span>
                                @endif
                            </div>
                                    ...
                                    <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition
                                        ...
                                        <div class="flex items-start gap-2">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p
                                                    class="text-sm {{ $notif->leida ? 'text-gray-500' : 'text-gray-800 font-medium' }} truncate">
                                                    {{ $notif->mensaje }}
                                                </p>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-indigo-800">
        ...
        <div class="px-4 pt-2 pb-3 space-y-2">
            ...
            <a href="{{ route('dashboard') }}" class="block text-white hover:text-blue-200">
                Dashboard
            </a>

            @if(Auth::user()->rol === 'Admin')
                <a href="{{ route('usuarios.index') }}" class="block text-white hover:text-blue-200">
                    Usuarios
                </a>
                <a href="{{ route('admin.reportes.index') }}" class="block text-white hover:text-blue-200">
                    Reportes
                </a>
            @elseif(Auth::user()->rol === 'Profesor')
                <a href="{{ route('profesor.asistencias.index') }}" class="block text-white hover:text-blue-200">
                    Asistencias
                </a>
            @elseif(Auth::user()->rol === 'Técnico')
                <a href="{{ route('tecnico.asistencias.index') }}" class="block text-white hover:text-blue-200">
                    Asistencias
                </a>
                <a href="#" class="block text-white hover:text-blue-200">
                    Bitácora
                </a>
            @endif

            <a href="{{ route('notificaciones.index') }}" class="block text-white hover:text-blue-200">
                🔔 Notificaciones
                @auth
                    @if(Auth::user()->notificacionesNoLeidas() > 0)
        ...
        <div class="pt-4 pb-1 border-t border-indigo-700">
            ...
            <div class="mt-3 space-y-1 px-2 pb-3">
                <a href="{{ route('profile.edit') }}"
                    class="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-blue-200 hover:bg-indigo-700">
                    Perfil
                </a>
