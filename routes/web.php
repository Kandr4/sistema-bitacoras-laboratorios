...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('role:Admin')->group(function () {
        ...
        Route::prefix('respaldos')->name('backups.')->group(function () {
            Route::get('/', [\App\Http\Controllers\BackupController::class, 'index'])->name('index');
            Route::post('/generar', [\App\Http\Controllers\BackupController::class, 'generarRespaldo'])->name('generar');
            Route::get('/descargar/{filename}', [\App\Http\Controllers\BackupController::class, 'descargarRespaldo'])->name('descargar');
            Route::post('/restaurar', [\App\Http\Controllers\BackupController::class, 'restaurarRespaldo'])->name('restaurar');
        });
    });
